package com.example.SubscriptionService.Authservice;
...
public class JwtAuthConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    public UUID getAthenaticatedUserId(Jwt jwt){
        return UUID.fromString(jwt.getClaim("sub"));
    }
    public UserModel extractCustomerInfoFromJwt(Jwt jwt) {
        ...
        return new UserModel(id, username, firstname, lastname, email);
    }
}
